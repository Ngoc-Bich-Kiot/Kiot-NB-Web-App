...
const ProductTable = () => {
  ...
  const tableHeaderTitle = [
    ...
    { id: "name", label: "Tên sản phẩm", align: "center", introId: "name-header" },
    //{ id: "category", label: "Loại", align: "center" },
    //{ id: "sourceOfProducts", label: "Nguồn nhập", align: "center" },
    { id: "sellingPrice", label: "Giá bán", align: "center", format: "price", introId: "selling-price-header" },
    //{ id: "importCosts", label: "Giá nhập", align: "center", format: "price", introId: "import-costs-header" },
    { id: "stockQuantity", label: "Số lượng tồn", align: "center", format: "quantity", introId: "stock-quantity-header" },
    { id: "unit", label: "Đơn vị", align: "center", introId: "unit-header" },
    { id: "createDate", label: "Ngày tạo", align: "center", format: "date", introId: "date-header" },
    {
      id: "isDeleted",
      label: "Trạng thái",
      align: "center",
